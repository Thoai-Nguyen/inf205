...
<html>
    ...
    <body>
       <a href="${pageContext.servletContext.contextPath}/user/index.htm">Quản Lý User</a>
        ...
        <h1>Update Depart</h1>
        <form:form action="${pageContext.servletContext.contextPath}/depart/update/.htm" modelAttribute="depart" method="post">
            <div>
                <label>DepartID : </label>
                <form:input path="depId" readonly="true" style="color:red;border: 0px"/>
            </div>
            <div>
                <label>Name : </label>
